...
fn labeled_reports_detection_and_fpr_per_category() {
    eval_command()
        ...
        .assert()
        .success()
        .stdout(predicate::str::contains("samples: total=177 categories=23"))
        ...
        .stdout(predicate::str::contains(
            "category=buried_question_list\tfire=10/10 detection=1.000 ci95=0.722-1.000\tsilent_fired=0/10 fpr=0.000 ci95=0.000-0.278",
        ))
        .stdout(predicate::str::contains(
            "category=declared_item_count_mismatch\tfire=10/10 detection=1.000 ci95=0.722-1.000\tsilent_fired=0/10 fpr=0.000 ci95=0.000-0.278",
        ))
